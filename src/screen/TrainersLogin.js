...
const TrainersLogin = (props) => {
    ...
    const handleLoginBtn = async () => {
        ...
        try{
            ...
            formData.append('method', 'member_loginTrainers');
        ...
        <Box flex={1} bg='#fff'>
            <KeyboardAvoidingView>
                <TouchableWithoutFeedback onPress={Keyboard.dismiss} >
                    <>
                        <HeaderDef navigation={navigation} headertitle='바디케어 트레이너 회원 로그인' />
                        <Box bg='#fff' height='100%'>
                            <VStack px={5}>
                                ...
                                <Box alignItems='flex-end'>
                                    ...
                                    <TouchableOpacity 
                                        style={[{marginTop:20}]} 
                                        onPress={()=>{navigation.navigate('Inquiry', {'inqType':'트레이너 가입문의'})}}
                                    >
                                        <HStack alignItems='center'>
                                            <Image 
                                                source={
                                                ...
                                                mr={3}                                    
                                            />
                                            <DefText text='트레이너 회원가입 문의' style={[styles.loginButtonTexts]}  />
                                        </HStack>
                                    </TouchableOpacity>
