...
const WishAreaInsert1 = (props) => {
    ...
    const areaSaveSplit = areaSave.split(' ');
    ...
    const _handleWishArea = () => {
        ...
        const areas = areaSelect + ' ' + areaGuSelect + ' ' + areaDongSelect;

        //console.log(areas);

        navigation.navigate('MypageInfo', {areas})
    }
...
export default WishAreaInsert1;