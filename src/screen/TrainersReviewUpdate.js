...
const TrainersReviewUpdate = (props) => {
    ...
    const [trainersContent, setTrainersContent] = useState('');
    const trainersFormChange = (text) => {
        setTrainersContent(text);
    }
    ...
    const ReviewUpdate = async () => {
        ...
        Api.send('contents_trainersReviewUpdate', {'mb_id':userInfo.mb_id, 'wr_id':params.wr_id, 'wr_name':userInfo.mb_name, 'wr_content':trainersContent, 'score':scoreStar}, (args)=>{
            ...
            if(resultItem.result === 'Y' && arrItems) {
                ...
                setTrainersContent('');
                navigation.replace('TrainersReviewUpdate', params);
            }else{
    ...
    return (
        <Box flex={1} backgroundColor='#fff'>
            <HeaderDef navigation={navigation} headertitle='트레이너 후기 작성' />
            <ScrollView>
                <VStack px={5} py={5}>
                     <Box>
                        <HStack alignItems='center' mb={2.5}>
                            <DefText text='트레이너' style={{fontSize:16, color:'#000', fontFamily:Font.RobotoBold, width:'20%'}} />
                            <DefText text={params.wr_subject + ' 트레이너'} />
                        </HStack>
                    </Box>
                    <Box mt={5}>
                        <HStack alignItems='center' mb={2.5}>
                        ...
                        <Box mt={5}>
                            <HStack  mb={2.5}>
                                ...
                                <Input 
                                    ...
                                    height={150}
                                    width='80%'
                                    onChangeText={trainersFormChange}
