...
import { TouchableOpacity, FlatList, StyleSheet, ScrollView, Alert, Platform } from 'react-native';
...
const MypageInfo = (props) => {
    ...
    useEffect(()=>{
        ...
        setExercisePurpose(userInfo.mb_5);
        setWishExerType(userInfo.mb_6);
    ...
    const _registerInsertSubmit = () => {
        ...
        // Api.send('member_registerInsert', {'id':userInfo.mb_id, 'phonNumber':phoneNumber, 'names':name,'nickName':nickName,'age':age,'gender':genderState, 'wisharea1':areaInput1, 'wisharea2':areaInput2, 'wisharea3':areaInput3,'purposeCheck':exercisePurpose,'wishExer':wishExerType, 'photo':profileImgs}, (args)=>{
        //     let resultItem = args.resultItem;
        //     let arrItems = args.arrItems;

        //     if(resultItem.result === 'Y' && arrItems) {

        //         console.log('내정보 수정 출력..',resultItem);
                        ...
                        <Box>
                            {
                                ...
                                <Image source={{uri:profileImgs.uri} }
                                    alt='프로필 이미지'
                                    style={{width:110, height:107, borderRadius:107}}
                                />
                                :
                                <Image source={{uri:userInfo.mb_profile_img} }
                                    alt='프로필 이미지'
                                    style={{width:110, height:107, borderRadius:107}}
                                />
                            }
