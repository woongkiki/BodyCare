...
const WishExerciseType = (props) => {
    ...
    //console.log('dsda',wisthExerDatas)
    ...
    return (
        <Box flex={1} bg='#fff'>
            ...
            <TouchableOpacity 
                ...
                onPress={()=>{navigation.navigate('RegisterMyInfo', {wishExerciseTypeList})}}
            >
...
export default WishExerciseType;